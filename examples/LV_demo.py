...
if __name__ == '__main__':
    ...
    orig_trajs, samp_trajs, orig_ts, samp_ts, sample_plot_range = generate_LV(
        batch=batch,
        noise_std=noise_std
    )
    ...
    try:
        ...
        for itr in range(1, args.niters + 1):
            ...
            if args.viz and itr % 10 == 0 or itr == 1:
                ...
                ax_traj.set_ylabel('pradator (albastru), prada (verde')
                ...
                plt.draw()
                plt.savefig('lv_png/{:03d}'.format(itr))
                plt.pause(0.001)
    ...
    if args.viz:
        ...
        plt.ylabel('Loss')
        plt.savefig('lv_train_loss.png')

    with open("lv_loss.txt", "wb") as fp:   # Pickling
